  ...
  return (
    <input
      ...
      className={classNames(
        "bg-surface autofill:bg-surface hover:autofill:bg-surface focus:autofill:bg-surface active:autofill:bg-surface rounded-12 px-16 py-[15px] text-[15px] text-white placeholder:text-[15px] placeholder:text-[#696969] focus:outline-none",
        {
...
export const InputGroup = ({ children }: InputGroupProps) => {
  return (
    <div className="bg-surface flex w-full flex-col rounded-12">{children}</div>
  );
};
